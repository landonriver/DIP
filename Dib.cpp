...
/*************************************************************************
 * 函数名称：GetbmfHeaderSize()
 * 函数类型: DWORD
 * 函数功能: 返回位图文件大小，包括这14个字节
 *************************************************************************/
DWORD CDib::GetbmfHeaderSize()
{
	// TODO: 在此处添加实现代码.
	return bmfHeader.bfSize;
}
/*************************************************************************
 * 函数名称：GetbmfHeaderBits()
 * 函数类型: DWORD
 * 函数功能: 返回从文件头到实际的位图数据的偏移字节数
 *************************************************************************/
DWORD CDib::GetbmfHeaderBits() 
{
